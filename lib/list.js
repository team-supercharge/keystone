...
module.exports = function (keystone) {
	...
	function List (key, options) {
		...
		var defaultOptions = {
			...
			defaultRelationshipColumns: '__name__'
		};
	...
	Object.defineProperty(List.prototype, 'defaultRelationshipColumns', {
		get: function () {
			if (!this._defaultRelationshipColumns) {
				this._defaultColumns = this.expandColumns(this.get('defaultRelationshipColumns'));
			}
			return this._defaultRelationshipColumns;
		}, set: function (value) {
			this.set('defaultRelationshipColumns', value);
			delete this._defaultRelationshipColumns;
		},
	});
